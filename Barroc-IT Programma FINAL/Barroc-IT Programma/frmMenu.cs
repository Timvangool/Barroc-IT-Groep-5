    ...
    public partial class frmMenu : Form
    {
        ...
        private void btnAdminPanel_Click(object sender, EventArgs e)
        {
           bool admin = permissions();
            ...
            if(admin)
            {
                MessageBox.Show("ADMIN PANEL COMES HERE WIP");
            }
            else
            {
        ...
        private void btnCustomers_Click(object sender, EventArgs e)
        {
            ...
            frmCustomersMenu frmCustomer = new frmCustomersMenu(this, frmloginpanel, username);
            frmCustomer.Show();
        ...
        {
            frmInvoices frmInvoice = new frmInvoices(frmloginpanel, this);
            this.Opacity = 0;
            this.ShowInTaskbar = false;
            frmInvoice.Show();
        }
